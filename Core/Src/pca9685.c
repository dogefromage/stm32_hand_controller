...
// HAL_StatusTypeDef PCA9685_SetPWM(I2C_HandleTypeDef *hi2c, uint8_t Channel, uint16_t OnTime, uint16_t OffTime)
// {
//   HAL_StatusTypeDef err;
...
HAL_StatusTypeDef PCA9685_SetAllPWM(
